import{r as a,j as o,a as t,b as u}from"./app-eae9fd7a.js";import{a as ae}from"./moment-1c676225.js";import{Q as r}from"./react-toastify.esm-183d4a81.js";import oe from"./Tujuan-188f5595.js";const ne=({shipments:B,selectedDate:k})=>{const I=/@(-?\d+\.?\d*),/,L=/,(-?\d+\.?\d*)/,[P,A]=a.useState(!0),[F,R]=a.useState(!1),[y,N]=a.useState(!1),[s,w]=a.useState(0),[Y,C]=a.useState([]),[K,E]=a.useState(""),[$,z]=a.useState(""),[l,S]=a.useState(""),[h,_]=a.useState(""),[b,D]=a.useState(""),[f,H]=a.useState(""),[d,x]=a.useState(1),[i,c]=a.useState(0),[m,Q]=a.useState(0),[v,U]=a.useState(0),W=()=>{u.get("/get_harga").then(function(e){e.data.map(n=>{Q(n.kiriman_single),U(n.kiriman_multiple)})})},M=()=>{c(s===0?m:i===m?v*2:i+v)},q=()=>{i==v*2?c(m):c(i-v)},G=()=>{w(s+1),x(d+1),M()},J=()=>{u.get("/tujuan").then(function(e){e.data?x(d+1+e.data):x(2)}).catch(function(e){console.log(e)})};a.useEffect(()=>{J(),W()},[]);const V=e=>{e.preventDefault();const n=ae(k).format("YYYY-MM-DD");l==""?r.warning("Silahkan isi No telp terlebih dahulu",{position:"top-right",autoClose:5e3,hideProgressBar:!1,closeOnClick:!0,pauseOnHover:!0,draggable:!0,progress:void 0,theme:"colored"}):h==""?r.warning("Silahkan isi Nama terlebih dahulu",{position:"top-right",autoClose:5e3,hideProgressBar:!1,closeOnClick:!0,pauseOnHover:!0,draggable:!0,progress:void 0,theme:"colored"}):b==""?r.warning("Silahkan isi Alamat shipment terlebih dahulu",{position:"top-right",autoClose:5e3,hideProgressBar:!1,closeOnClick:!0,pauseOnHover:!0,draggable:!0,progress:void 0,theme:"colored"}):u.post("/customer",{nama:h,no_telp:l}).then(function(g){E(g.data.id),u.post("/shipments",{alamat:b,link_maps:f,customer_id:g.data.id,status_shipment:"Not Completed",total_harga:m,tanggal_kiriman:n}).then(function(p){z(p.data.id);const O=f,T=O.match(I),j=O.match(L),te=T&&j?parseFloat(T[1])+","+parseFloat(j[1]):null;A(!1),w(1),R(!0),u.post("/tujuan",{nama_penerima:h,no_telp_penerima:l,alamat_penerima:b,link_maps:f,type:"Pickup",status:"Belum Dikirim",urutan:B.length==0?1:d-1,shipment_id:p.data.id,newTotalHarga:m,latlng:te,tanggal_kiriman:n}),r.success("Shipment berhasil di buat",{position:"top-right",autoClose:5e3,hideProgressBar:!1,closeOnClick:!0,pauseOnHover:!0,draggable:!0,progress:void 0,theme:"colored"}),M()}).catch(function(p){r.error("Sorry, Shipment gagal di buat!",{position:"top-right",autoClose:5e3,hideProgressBar:!1,closeOnClick:!0,pauseOnHover:!0,draggable:!0,progress:void 0,theme:"colored"})})}).catch(function(g){r.error("Sorry, Shipment gagal di buat!",{position:"top-right",autoClose:5e3,hideProgressBar:!1,closeOnClick:!0,pauseOnHover:!0,draggable:!0,progress:void 0,theme:"colored"})})},X=e=>{e.preventDefault(),N(!y),l==""?C([]):u.get("/load_customers").then(function(n){var g=n.data;C(g.filter(p=>p.no_telp.includes(l)))})},Z=()=>{s===1?r.warning("Minimal 1 tujuan",{position:"top-right",autoClose:5e3,hideProgressBar:!1,closeOnClick:!0,pauseOnHover:!0,draggable:!0,progress:void 0,theme:"colored"}):(w(s-1),x(d-1),q())},ee=e=>new Intl.NumberFormat("id-ID",{style:"currency",currency:"IDR",minimumFractionDigits:0}).format(e);return o("div",{className:"p-6 h-auto",children:[t("form",{children:o("div",{className:"grid md:grid-cols-5",children:[o("div",{className:"form-group mb-6 md:mx-3 relative",children:[t("label",{className:"form-label inline-block mb-2 text-gray-700",children:"No Telp"}),o("div",{className:"flex",children:[t("input",{value:l,onChange:e=>S(e.currentTarget.value),type:"number",className:`form-control
          ...
          ease-in-out
          m-0
          focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none`,placeholder:"Nama"})]}),o("div",{className:"form-group mb-6 md:mx-3",children:[t("label",{className:"form-label inline-block mb-2 text-gray-700",children:"Alamat"}),t("input",{value:b,onChange:e=>D(e.currentTarget.value),type:"text",className:`form-control
          block
          w-full
          px-3
          py-1.5
